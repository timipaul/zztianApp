...
import com.timi.framedemo.Utils.BaseActivity;
import com.timi.framedemo.Utils.GetHttpImg;
import com.timi.framedemo.Utils.RainbowPalette;

/**
 *
 */
public class ReadRankingActivity extends BaseActivity implements RainbowPalette.OnColorChangedListen ,View.OnClickListener,SeekBar.OnSeekBarChangeListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.home_read_ranking);
    ...
    protected void initView() {
        ...
        //获取网络图片并缓存
        GetHttpImg.setUserImg(imgview, "http://p872ue3rt.bkt.clouddn.com/9335935_195635332170_2.jpg");
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Picasso.with(ReadRankingActivity.this)
                   .load("http://p872ue3rt.bkt.clouddn.com/9335935_195635332170_2.jpg")
                   .into(imgview);
            }
        });
    }
