 ...
 * 浏览历史 - 剧本
 */
public class PreviewCommunityFragment extends BaseFragment {
    ...
    protected View initView() {
        final View view = View.inflate(mContext, R.layout.home_collect,null);
        mAutoWrapLineLayout = (AutoWrapLineLayout) view.findViewById(R.id.awl_home_collect_layout);
