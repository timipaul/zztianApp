 ...
 * 浏览历史 - 漫画故事
 */
public class PreviewStoryFragment extends BaseFragment{
    ...
    private Integer[] image = {R.drawable.home_catroon_1, R.drawable.home_catroon_2, R.drawable.home_catroon_3,
            R.drawable.home_catroon_4, R.drawable.home_catroon_5, R.drawable.home_catroon_6};
    ...
    private void addView(int number) {
        ...
        for (int i = 0; i < number; i++) {
            ...
            mImageView.setImageResource(image[r.nextInt(6)]);
    ...
    public void setTextNameStyle(TextView tv) {
        LayoutParams param = new LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
